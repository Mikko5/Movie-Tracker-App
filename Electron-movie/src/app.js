...
const getDOMElements = () => {
    return {
        ...
        openBackupModalBtn: document.getElementById('open-backup-modal-btn'),

        // Backup & Storage modal
        backupModal: document.getElementById('backup-modal'),
        backupCloseBtn: document.querySelector('.backup-close-btn'),
        selectSaveLocationBtn: document.getElementById('select-save-location-btn'),
        selectBackupLocationBtn: document.getElementById('select-backup-location-btn'),
        backupNowBtn: document.getElementById('backup-now-btn'),
        removeBackupFolderBtn: document.getElementById('remove-backup-folder-btn'),
        toggleAutoBackupCheckbox: document.getElementById('toggle-auto-backup-checkbox'),
